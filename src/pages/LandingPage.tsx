          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative">
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="w-80 h-80 border-2 border-dashed border-[#F5C518]/30 rounded-full"></div>
              </div>
              <div className="relative grid grid-cols-2 gap-4">
                <div className="bg-[#FFFBF0] rounded-2xl p-6 card-shadow">
                ...
                <div className="bg-[#FFFBF0] rounded-2xl p-6 card-shadow mt-8">
